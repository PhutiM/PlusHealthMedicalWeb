...
<a href="insert_client.php" class="btn btn-success pull-right">Add New Clients</a>
...
<?php
    ...
    $sql = "SELECT * FROM client_data order by client_name asc";
    if($result = mysqli_query($db, $sql)){
        if(mysqli_num_rows($result) > 0){
            ...
            while($row = mysqli_fetch_array($result)){
                ...
                echo "<td>";
                echo "<a href='update.php?id=". $row['client_id'] ."'' class='btn btn-success pull-right'>   Edit Client    </a> </td>";
                echo "<td>";
                echo "<a href='insert_appointment.php?client_id=" . $row['client_id'] ."' class='btn btn-success pull-right'> Book Appointment </a> </td>";
